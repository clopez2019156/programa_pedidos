...
function guardar() {
    ...
    //     Swal.fire({
    //         title: 'Espere!',
    //         text: "Por favor ingrese la fecha del depósito",
    //         icon: 'warning'
    //     });
    // }
    // else 
            ...
            listo.forEach(listo => {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        // else if (!(monto > (saldo_a_cobrar - 1) && monto < (saldo_a_cobrar + 1))) {
                        //     Swal.fire({
                        //         title: 'Epere!',
                        //         text: "El monto ingresado no coincide con las saldos registrados!",
                        //         icon: 'warning'
                        //     });
                        //     return;
                        // }
